    ...
    chartSocSoh.setOption({
        series: [
            ...
            },
            {
                ...
                title: { show: false },
                detail: { valueAnimation: true, offsetCenter: ['35%', '133%'], fontSize: 13, fontWeight: 'bold', formatter: 'SOH {value}%', color: '#10b981' },
                data: [{ value: 95 }]
            }
        ]
    });
    ...
    chartTemps.setOption({
        series: [
            ...
            },
            {
                ...
                title: { show: false },
                detail: { valueAnimation: true, offsetCenter: ['40%', '200%'], fontSize: 12, fontWeight: 'bold', formatter: 'S2 {value}°', color: '#06b6d4' },
                data: [{ value: 22 }]
            }
        ]
    });
