...
- Instanciation de `gui::GuiRoot` (init/start) pour connecter la GUI à l'EventBus.
...
5. **GUI** : instancie `gui::GuiRoot` avec l'EventBus afin que les écrans puissent publier ou consommer des événements (changement de mode, affichage des stats).
